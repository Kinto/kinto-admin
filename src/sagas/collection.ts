...
export function* deleteAttachment(
  ...
  try {
    ...
    notifyError("Couldn't delete attachment.", error);
  } finally {
...
export function* createRecord(
  ...
  try {
    ...
    notifyError("Couldn't create record.", error);
  } finally {
...
export function* updateRecord(
  ...
  try {
    ...
    notifyError("Couldn't update record.", error);
  } finally {
    yield put(recordBusy(false));
  }
}
...
export function* deleteRecord(
  ...
  try {
    ...
    notifyError("Couldn't delete record.", error);
  } finally {
    yield put(recordBusy(false));
  }
}
