...
export const PLUGIN_CONFIRM_ROLLBACK_CHANGES =
  "PLUGIN_CONFIRM_ROLLBACK_CHANGES";
export const PLUGIN_ROLLBACK_CHANGES = "PLUGIN_ROLLBACK_CHANGES";
...
export const PLUGIN_DECLINE_AND_DISCARD_REQUEST =
  "PLUGIN_DECLINE_AND_DISCARD_REQUEST";
